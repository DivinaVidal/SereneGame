...
function (p) {
	...
	c.VERSION = "3.4.0", c.TRANSITION_DURATION = 0, c.DEFAULTS = {
		interval: false,
		pause: "hover",
		wrap: !0,
		keyboard: !0
...
function (a) {
	...
	r.VERSION = "3.4.0", r.TRANSITION_DURATION = 0, r.DEFAULTS = {
		toggle: !0
...
function (a) {
	...
	s.VERSION = "3.4.0", s.TRANSITION_DURATION = 0, s.BACKDROP_TRANSITION_DURATION = 0, s.DEFAULTS = {
		backdrop: !0,
		keyboard: !0,
		show: !0
...
function (g) {
	...
	m.VERSION = "3.4.0", m.TRANSITION_DURATION = 0, m.DEFAULTS = {
		animation: !0,
		placement: "top",
		selector: !1,
...
function (r) {
	...
	a.VERSION = "3.4.0", a.TRANSITION_DURATION = 0, a.prototype.show = function () {
		var t = this.element,
